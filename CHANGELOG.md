...
- Add `bin/setup` as the one-command fresh-machine entrypoint.
- Add mise-first CLI ownership with Homebrew fallbacks for unsupported tools.
- Add typed app manifest support for cask, formula, mise, mas, and manual installs.
